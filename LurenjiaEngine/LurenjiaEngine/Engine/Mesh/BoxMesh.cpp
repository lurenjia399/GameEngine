...
void CBoxMesh::CreateMeshRenderData(FMeshRenderingData& InRenderingData, const float& Inheight, const float& Inwidth, const float& Indepth)
{
	...
	InRenderingData.VertexData.emplace_back(FVertex(XMFLOAT3(cwidth, cheight, -cdepth),XMFLOAT4(Colors::Bisque)));					//2
	InRenderingData.VertexData.emplace_back(FVertex(XMFLOAT3(cwidth, -cheight, -cdepth),XMFLOAT4(Colors::DarkMagenta)));			//3
	...
	InRenderingData.VertexData.emplace_back(FVertex(XMFLOAT3(cwidth, cheight, cdepth),XMFLOAT4(Colors::AliceBlue)));				//6
	InRenderingData.VertexData.emplace_back(FVertex(XMFLOAT3(cwidth, -cheight, cdepth),XMFLOAT4(Colors::Violet)));					//7
